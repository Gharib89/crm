...
| customizations: model-driven apps, sitemap live-edit (add-area / add-group / add-subarea / remove-node), web resources, ribbon, forms, charts, dashboards, themes, reports | `reference/customizations.md` |
