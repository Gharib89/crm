...
_ENTITY_DEFS = [
    ...
    {
        "LogicalName": "cwx_widget",
        "EntitySetName": "cwx_widgets",
        "PrimaryIdAttribute": "cwx_widgetid",
        "PrimaryNameAttribute": "cwx_name",
    },
    {
        "LogicalName": "owner",
...
_M2O: dict[str, list[dict[str, str]]] = {
    "account": [
        ...
        {
            "ReferencingAttribute": "cwx_widgetid",
            "ReferencedEntity": "cwx_widget",
        ...
        {
            "ReferencingAttribute": "cwx_regardingid",
            "ReferencedEntity": "contact",
